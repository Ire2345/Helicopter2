...
function setup() {
	...
	box1Sprite=createSprite(410,645,100,20);
	box1Sprite.shapeColor="red"


	box2Sprite=createSprite(470,600,20,200);
	box2Sprite.shapeColor="red"

box3Sprite=createSprite(370,600,20,200);
box3Sprite.shapeColor="red"
  ...
  box1= new Box(410,670,100,20)
	 box2=new Box(460,670,100,20);
	 box3=new Box(435,670,20,200);
...
function draw() {
  ...
  packageSprite.y= packageBody.position.y 
	...
	packageSprite.collide(box3Sprite)	
  drawSprites();
